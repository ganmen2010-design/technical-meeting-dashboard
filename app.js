...
function renderGuidelines(items) {
      ...
      <div class="glass-card section-card" style="margin-bottom: 20px;">
        <div class="card-header" style="flex-direction: column; align-items: flex-start; gap: 8px;">
          <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; flex-wrap: wrap; gap: 12px;">
            <div class="section-title-group" style="display: flex; align-items: center; gap: 12px;">
              <i class="fa-solid fa-book-bookmark section-icon text-cyan" style="font-size: 26px;"></i>
              <div>
                <h3 style="margin: 0; font-size: 20px;">發布技術指引 (00發布區)</h3>
                <p class="section-subtitle" style="margin: 4px 0 0 0; color: var(--text-dim); font-size: 14px;">收錄技術會議運作標準作業模板、地質改良樁工法參數與各項發布規劃指引</p>
              </div>
            </div>
            <button type="button" class="btn-table-action" onclick="copyNasPath('${encodeURIComponent(nas00Path)}')" style="padding: 8px 16px; font-size: 14px;">
              <i class="fa-regular fa-copy text-cyan"></i> 複製 00發布區 NAS 路徑
            </button>
          </div>
          <div class="category-meta-badge" style="margin-top: 4px; font-size: 13.5px; color: #a5f3fc; background: rgba(0,242,254,0.08); padding: 6px 14px; border-radius: 6px; border: 1px solid rgba(0,242,254,0.2); width: 100%;">
            <i class="fa-solid fa-server text-cyan"></i> <b>NAS 實體專區：</b>\\\\192.168.1.221\\s5\\1003技術會議資料專區\\2.技術會議運作指引(供查看及下載)\\00發布區
          </div>
        </div>
      </div>
      <div class="search-empty-prompt"><i class="fa-solid fa-folder-open"></i><p>00發布區目前尚無檔案</p></div>
    `;
    return;
  }
      ...
      <div class="card-header" style="flex-direction: column; align-items: flex-start; gap: 8px;">
        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; flex-wrap: wrap; gap: 12px;">
          ...
          <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            ...
            <button type="button" class="btn-table-action" onclick="toggleAllGuidelineFolders(true)" style="padding: 8px 16px; font-size: 14px;">
              <i class="fa-solid fa-square-plus text-cyan"></i> 全部展開
            </button>
            <button type="button" class="btn-table-action" onclick="toggleAllGuidelineFolders(false)" style="padding: 8px 16px; font-size: 14px;">
  ...
  list.innerHTML = headerHtml + cardsHtml;
}
...
const ENGINEERING_KNOWLEDGE_MATRIX = {
  "鋼軌樁": {
    topic: "鋼軌樁橫板條擋土工程 (Soldier Pile & Timber Lagging Shoring)",
    icon: "fa-bars",
    controlSheetSubitems: [
      "鋼軌樁型號規格與打設間距檢討",
      "橫板條 (木襯板/RC襯板) 規格厚度與插設密合度",
      "背填無收縮砂漿/級配碎石防掏空檢討",
      "型鋼圍令 (Waler) 與水平/角撐支撐接合檢討",
      "地下水位降水 (點井/深井) 與防土砂流失不織布鋪設",
      "鋼軌樁拔除回填或地下層切除補強防水檢討"
    ],
    planning: [
      { badge: "管控表-規格間距檢討", text: "【管控表細項】鋼軌樁型號規格（重軌 30~50kg/m 或 H 型鋼）與中心間距（0.6~1.2m）檢討，計算貫入深度比以滿足抗傾覆穩定。" },
      { badge: "管控表-橫板條襯板厚度", text: "【管控表細項】橫板條（木襯板厚 ≥ 5~6cm 或預鑄 RC 板）強度檢討，確認開挖面土壤自立高度與插設順序。" },
      { badge: "管控表-背填防掏空", text: "【管控表細項】橫板條背側空隙背填無收縮砂漿、細砂或級配碎石，鋪設透水不織布，嚴防開挖期間周邊地層淘空沉陷。" },
      { badge: "管控表-圍令橫撐接合", text: "【管控表細項】鋼軌樁與型鋼圍令（Waler）、第一二道水平橫撐及角撐節點焊接、三角墊塊密貼與千斤頂預壓力施加檢討。" },
      { badge: "管控表-地下水位降水", text: "【管控表細項】地下水位檢討，規劃點井（Wellpoint）或深井抽水降水計畫至開挖面下 1.0m，防範透水層湧水破壞。" },
      { badge: "管控表-拔樁回填留置", text: "【管控表細項】地下室外牆完成後鋼軌樁拔除順序與樁孔水泥砂漿加壓注漿回填，或切除樁頂後外牆雙層防水封堵檢討。" }
    ],
    construction: [
      { badge: "導向放樣垂直打設", text: "以經緯儀校核軸線，設置型鋼導架引導打設，垂直度偏差嚴格控制 ≤ 1/200，嚴防前後扭轉偏斜。" },
      { badge: "分階開挖隨挖隨插", text: "挖土機每階開挖深度不得超過 1.0~1.2m，開挖後立即由上而下逐層安裝橫板條並打入楔形木塞固定緊密。" },
      { badge: "透水布與背填搗實", text: "橫板條背面全面鋪設透水不織布並回填乾燥砂石或低壓灌漿填實空隙，嚴禁殘留空洞誘發鄰近地表沉陷。" },
      { badge: "圍令托架牢固焊接", text: "型鋼圍令下方每支鋼軌樁均需滿焊重型角鋼托架（Bracket），圍令與鋼軌樁間以鋼墊塊密貼加勁。" },
      { badge: "拔樁即時加壓注漿", text: "若採拔除工法，拔樁機拔起同時透過灌漿管同步注入 1:2 水泥砂漿或雙液漿，100% 充填拔樁孔洞。" }
    ],
    pitfalls: [
      { name: "橫板條背側掏空地陷", cause: "開挖後未即時插板或背填不實，土砂受滲水沖刷流失", solution: "落實隨挖隨插板原則（開挖後 2hr 內完成），板背鋪設透水不織布並以水泥砂漿灌注填實。" },
      { name: "鋼軌樁打設偏位扭曲", cause: "地質遭遇地下障礙物或未設導架硬打", solution: "設置剛性型鋼導架；遇硬層預先以螺旋鑽（Auger）引孔導向後再行植樁。" },
      { name: "板縫大量滲水漏砂", cause: "地下水位高於開挖面且降水不足", solution: "開挖前完成周邊點井降水使水位降至開挖面下 1.0m；板縫處以快乾止水水泥砂漿嵌縫堵漏。" },
      { name: "相鄰建物傾斜沉陷", cause: "開挖過深未及時施加支撐預力或拔樁孔塌陷", solution: "每階開挖立即架設圍令並施加 100% 設計預力；拔樁作業嚴格落實水玻璃加壓同步灌漿回填。" }
    ]
  },
  "中間樁": {
    topic: "中間樁與立柱工程 (Intermediate King Post & Column)",
    icon: "fa-arrows-down-to-line",
    controlSheetSubitems: [
      "中間樁位置與結構梁柱/版開口避開套繪",
      "中間樁預鑽孔徑、垂直度與底層植入岩盤深度",
      "型鋼柱垂直度放樣與導架校正",
      "結構穿樁處止水鋼板環 (Water-Stop Ring) 焊接",
      "中間樁拔除或地下各層切除補強防水處理"
    ],
    planning: [
      { badge: "管控表-位置梁柱避開", text: "【管控表細項】中間樁（King Post）位置與地下室結構柱、大梁、集水坑及車行動線套繪，避開主要結構構件。" },
      { badge: "管控表-鑽孔貫入深度", text: "【管控表細項】預鑽孔徑、垂直度與植入開挖面下岩盤/硬土層深度檢討，計算單樁垂直承載力與抗拔力。" },
      { badge: "管控表-立柱垂直度", text: "【管控表細項】H型鋼立柱垂直度（偏差 ≤ 1/500）放樣檢討，設計專用雙向微調導向定位架。" },
      { badge: "管控表-止水鋼板環", text: "【管控表細項】中間樁穿過基礎底版、各地下樓板處，全周滿焊 6~9mm 止水鋼板環（Water-Stop Ring）與膨脹止水帶。" },
      { badge: "管控表-切除補強防水", text: "【管控表細項】結構完成後中間樁拔除工法，或依結構技師簽證於樓板面下 5cm 切除並以無收縮防水砂漿封堵補強。" }
    ],
    construction: [
      { badge: "全套管引孔垂直校正", text: "採用全套管或螺旋鑽引孔，以雙向經緯儀全程監控鑽孔垂直度，偏差嚴格控制 ≤ 1/300。" },
      { badge: "柱腳水泥砂漿灌注", text: "吊放 H 型鋼立柱至孔底後，底部灌注高強度無收縮水泥砂漿（長度 ≥ 3.0m）牢固錨定柱腳。" },
      { badge: "樁身孔洞乾燥回填", text: "柱腳錨定硬化後，樁身開挖段以乾燥細砂或碎石回填，防止地表水灌入孔內。" },
      { badge: "水平支撐牛腿焊接", text: "水平支撐交會處，中間樁全周依設計滿焊加勁托架（牛腿）與抗剪加勁板。" },
      { badge: "穿版止水環滿焊", text: "底版澆置前，中間樁周邊止水鋼板環必須進行 100% 滲透探傷（PT）檢驗，確保無砂眼漏水點。" }
    ],
    pitfalls: [
      { name: "中間樁偏斜干擾梁柱", cause: "吊放植樁時未設校正導架或泥漿浮力推移", solution: "設置專用鋼製雙向定位導架，以千斤頂雙向校正垂直度直至柱腳砂漿初凝。" },
      { name: "穿版處日後嚴重滲水", cause: "止水環未滿焊、有焊渣孔洞或混凝土未振搗密實", solution: "止水鋼板環雙面滿焊並打設水膨脹止水膠，澆置時加強周邊二次插入式震動棒振搗。" },
      { name: "柱腳承載力不足下陷", cause: "孔底沉泥未清或砂漿灌注長度不足", solution: "植樁前徹底清孔抽除沉渣，柱腳灌漿量需經計量筒精確換算並留置試體試壓。" }
    ]
  },
  "地錨": {
    topic: "預力地錨擋土工程 (Prestressed Ground Anchor Shoring)",
    icon: "fa-anchor",
    controlSheetSubitems: [
      "地錨設計拉力、自由段/錨錠段長度檢討",
      "鋼絞線防蝕套管、灌漿壓力與二次加壓灌漿",
      "千斤頂張拉試驗 (Pull-out Test) 與預力鎖定值",
      "相鄰私有地/道路越界施工許可與地下管線套繪",
      "地錨長期荷重計 (Load Cell) 監測與解鎖除役計畫"
    ],
    planning: [
      { badge: "管控表-錨錠段長度", text: "【管控表細項】預力地錨設計拉力、自由段（Free Length ≥ 4.5m）與錨錠段（Bond Length）深度檢討，錨入穩固地層。" },
      { badge: "管控表-防蝕套管灌漿", text: "【管控表細項】鋼絞線防蝕套管、止漿塞（Packer）位置、一次灌漿與二次高壓灌漿（Post-grouting）壓力（10~25 kg/cm²）檢討。" },
      { badge: "管控表-張拉鎖定試驗", text: "【管控表細項】千斤頂證明試驗（Proof Test）與適用性試驗，設定設計預力 115% 超張拉與鎖定荷重（Lock-off Load）。" },
      { badge: "管控表-越界管線套繪", text: "【管控表細項】地錨打設角度（15°~30°）與長度，套繪周邊自來水、瓦斯、台電等地下管線與鄰房基礎，取得地主越界同意書。" },
      { badge: "管控表-長期監測除役", text: "【管控表細項】地錨預力計（Load Cell）配置、長期荷重衰減監測及地下結構完成後地錨除役/應力解除計畫。" }
    ],
    construction: [
      { badge: "鑽孔角度精準控制", text: "鑽堡定位後以角度儀校正傾角（± 1° 以內），套管鑽進至設計深度，高壓水/氣徹底洗孔。" },
      { badge: "地錨體組裝與吊放", text: "鋼絞線依設計長度組裝，安裝定距環（Spacer）、二次灌漿管與防蝕套管，平順推入孔內嚴禁刮傷。" },
      { badge: "水泥漿壓力灌注", text: "由孔底一次灌注水灰比 0.45~0.50 之純水泥漿，初凝後視地質條件進行二次加壓劈裂灌漿提高摩擦力。" },
      { badge: "千斤頂分級張拉", text: "灌漿試體強度達 20 MPa（約 7 天）後，以校正千斤頂按 25%、50%、75%、100%、115% 分級張拉並記錄伸長量。" },
      { badge: "錨頭防蝕封蓋", text: "鎖定後錨頭塗抹防鏽油膏，安裝專用防蝕保護罩並灌注防蝕油脂封閉。" }
    ],
    pitfalls: [
      { name: "張拉滑動極限承載力不足", cause: "錨錠段土層摩擦力不足、清孔不全或灌漿不實", solution: "落實二次加壓劈裂灌漿（Post-grouting）；若延伸量超標立即補打追加補強地錨。" },
      { name: "鑽孔損壞鄰近地下管線", cause: "鑽孔角度偏斜或未依管線圖精準放樣", solution: "打設前於周邊進行人工試挖（Test Pit）確認管線位置，鑽進避開 1.5m 安全淨距。" },
      { name: "長期預力嚴重衰減鬆弛", cause: "黏土層潛變（Creep）或鋼絞線錨塞滑移", solution: "定期巡檢荷重計（Load Cell），若預力衰減超過設計容許值 15% 即時實施二次補張拉。" }
    ]
  },
  "鋼板樁": {
    topic: "鋼板樁擋土與止水工程 (Steel Sheet Pile Shoring & Water-Stop)",
    icon: "fa-shield-halved",
    controlSheetSubitems: [
      "鋼板樁規格型號與貫入深度檢討",
      "鋼板樁鎖扣密合與膨脹性止水膠泥塗抹",
      "導梁設置與打設垂直度放樣基準",
      "鋼板樁與型鋼圍令/水平支撐端點焊接與背填",
      "震動打樁機與靜壓植樁工法減震評估",
      "拔樁順序與拔樁孔水玻璃/水泥砂漿注漿回填"
    ],
    planning: [
      { badge: "管控表-規格貫入深度", text: "【管控表細項】鋼板樁規格型號（如 Type III / IV）與貫入深度（Penetration Depth）檢討，滿足側向被動土壓力與抗隆起穩定。" },
      { badge: "管控表-鎖扣止水塗抹", text: "【管控表細項】鋼板樁鎖扣（Interlock）密合度與止水膠泥（膨脹性水反應膠）塗抹檢討，嚴防高水位土層滲水湧砂。" },
      { badge: "管控表-導梁垂直放樣", text: "【管控表細項】雙層型鋼導梁（Guide Beam）設置與雙向垂直度放樣基準檢討，控制打設傾斜度偏差 ≤ 1/200。" },
      { badge: "管控表-圍令支撐接合", text: "【管控表細項】鋼板樁與型鋼圍令（Waler）、角撐、水平支撐端點焊接接合與型鋼背填三角墊塊密貼檢討。" },
      { badge: "管控表-工法減震評估", text: "【管控表細項】震動打樁機（Vibro Hammer）與靜壓植樁（Silent Piler）工法評估，鄰近建物之減震防沉陷監測計畫。" },
      { badge: "管控表-拔樁注漿回填", text: "【管控表細項】地下結構完成後拔樁順序、拔樁孔注漿回填（水玻璃/水泥砂漿加壓充填）檢討，防止地層空洞陷落。" }
    ],
    construction: [
      { badge: "雙層導梁定位校正", text: "架設上下雙層型鋼導梁牢固夾持，依測量軸線逐支精準對位，防止打設過程產生連續走鐘與扭轉偏位。" },
      { badge: "屏風式分組打設", text: "採用「屏風式工法（Panel Driving）」整組預插 10~20 支後逐支分階下打，嚴禁單支一次打到底造成鎖扣脫扣脫軌。" },
      { badge: "鎖扣塗佈止水油膏", text: "凹凸鎖扣槽於插樁前均勻塗刷專用膨脹性止水膏或牛油混合物，減少打設摩擦阻力並確保開挖擋水水密性。" },
      { badge: "型鋼圍令密貼加勁", text: "圍令安裝後與鋼板樁凹凸面包覆處以型鋼三角墊塊或早強無收縮砂漿填實，確保側向土壓力均勻傳遞至主支撐。" },
      { badge: "拔樁同步注漿充填", text: "拔除鋼板樁過程中，隨拔隨透過附掛注漿管進行水泥砂漿或雙液水玻璃加壓灌注，100% 填滿樁孔空洞防止鄰地沉陷。" }
    ],
    pitfalls: [
      { name: "鋼板樁脫扣與接縫漏水湧砂", cause: "地下遭遇孤石/硬層障礙物或打設偏斜硬擠脫軌", solution: "採用屏風式工法分散應力，遇硬地質預先以螺旋鑽（Auger Pre-boring）引孔破障後再行植樁。" },
      { name: "相鄰鋼板樁共沉（連帶下陷）", cause: "鎖扣摩擦阻力過大或泥砂卡死夾帶", solution: "在相鄰已打設至設計深度之樁頂以型鋼臨時點焊串連固定，並於鎖扣內塗抹潤滑油脂減摩。" },
      { name: "周邊地表沉陷或鄰房受損", cause: "震動引起砂土液化/密實或拔樁後孔洞塌陷", solution: "緊鄰既有建物時改採靜壓植樁機工法，拔樁全程嚴格落實水玻璃水泥漿同步加壓回填注漿。" },
      { name: "鋼板樁頂端側移變形過大", cause: "開挖深度超挖、未及時架設支撐或土壓超載", solution: "開挖依設計階層分段進行，開挖一面即時安裝第一道圍令並施加千斤頂預壓力（Pre-load）。" }
    ]
  },
  "連續壁": {
